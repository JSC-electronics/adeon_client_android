...
/**
 * Indicates whether the user bought a No Advertisements package.
 */
@Entity(tableName = "no_advertisements")
data class NoAdvertisements(val entitled: Boolean) : Entitlement() {
